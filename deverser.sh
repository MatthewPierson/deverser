...
echo ""
echo "[!] Welcome to Déverser, a simple script to dump onboard SHSH (Blobs) for iOS devices..."
...
ssh root@${ip} "cat /dev/rdisk1 | dd of=dump.raw bs=256 count=$((0x4000))"
...
echo "[!] SHSH should be dumped successfully at '${ecid}.dumped.shsh' (The number in the filename is your devices ECID)! Enojy!"
echo "[@] Written by Matty (@mosk_i)"
echo ""